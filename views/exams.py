...
penalty scoring, retake flow, and IntelliPace certificate issuance.
"""
...
| 5️⃣ **Certificate** | Score **{PASS_THRESHOLD:.0f}% or above** to earn an **IntelliPace Certificate**! 🏆 |
...
def _show_results(exam_rec: dict, subject_name: str):
    """Display passed exam results and IntelliPace certificate."""
    raw     = exam_rec.get("raw_score", 0)
            ...
            ">
                ...
                ">
                    ...
                    <div style="
                        ...
                        margin-top: 0.5rem;
                    ">POWERED BY INTELLIPACE AI · VERIFIED CERTIFICATE</div>
                </div>
            </div>
            """,
            unsafe_allow_html=True,
